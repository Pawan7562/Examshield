// create-test-questions.js - Create test questions for debugging
...
async function createTestQuestions() {
  ...
  try {
    ...
    console.log('\n🌐 Now you can test the delete functionality at: http://localhost:3001');
    console.log('📋 Go to Admin > Exams > Select the exam > Questions tab');
